...
class Clientes extends CI_Controller {
    ...
    function __construct() {
        parent::__construct();
            ...
            $this->load->model('conecte_model','',TRUE);
	...
	function gerenciar(){
        ...
        $config['base_url'] = base_url().'index.php/conecte/gerenciar/';
        $config['total_rows'] = $this->conecte_model->count('clientes');
        $config['per_page'] = 10;
