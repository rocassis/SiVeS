...
class sistema extends CI_Controller {
    ...
    /**
     * author: André de Melo
     * email: andrebrmelo@gmail.com
     * 
     */
    ...
    public function index() {
        ...
        $this->data['produtos'] = $this->sistema_model->estoqueBaixo();
        $this->data['prd'] = $this->produtos_model->getProdBaixa();
    ...
    public function editarEmitente() {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $retorno = $this->sistema_model->editEmitente($id, $nome, $cnpj, $ie, $logradouro, $numero, $bairro, $cidade, $uf,$telefone,$email);
            if($retorno){
