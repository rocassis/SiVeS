...
class Produtos extends CI_Controller {
    ...
    function gerenciar(){
	    ...
	    //$this->data['results'] = $this->produtos_model->get('produtos','idProdutos,descricao,unidade,precoCompra,precoVenda,estoque,estoqueMinimo','','',$this->uri->segment(3));
	    $this->data['results'] = $this->produtos_model->getProd('produtos','idProdutos,descricao,unidade,precoCompra,precoVenda,estoque,estoqueMinimo');
	    $this->data['rslts'] = $this->produtos_model->getProdBaixa();
    ...
    function editar() {
        ...
        if ($this->form_validation->run('produtos') == false) {
            ...
            $precoVenda = str_replace(",", "", $precoVenda);
            $estoque = $this->input->post('estoque');
            $unidade = $this->input->post('addEstoque');
            $soma_estoque = number_format($estoque + $unidade);
            $data = array(
    ...
    function mostrar() {
        ...
        $this->data['result'] = $this->produtos_model->get('produtos','*','','','');
