...
<html lang="en">
<head>
<title>SiVeSe - Sistema de Vendas e Serviços</title>
<meta charset="UTF-8" />
...
<!--Header-part-->
<div id="header">
  <h1><a href="">SiVeSe - Sistema de Vendas e Serviços</a></h1>
</div>
<!--close-Header-part--> 
        ...
        <li class="submenu <?php if(isset($menuConfiguracoes)){echo 'active open';};?>">
          ...
          <ul>
            ...
            <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'cEmitente')){ ?>
                <li><a href="<?php echo base_url()?>index.php/sistema/emitente">Emitente</a></li>
            <?php } ?>
            ...
            <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'cBackup')){ ?>
                <li><a href="<?php echo base_url()?>index.php/sistema/backup">Backup</a></li>
            <?php } ?>
...
<!--Footer-part-->
<div class="row-fluid">
  <div id="footer" class="span12"> 2017 &copy; Robert de Assis</div>
</div>
<!--end-Footer-part-->
