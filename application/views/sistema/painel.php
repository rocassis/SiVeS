...
<div class="row-fluid" style="margin-top: 0">
  <!-- Comentado por não utilizar estoque. -->
                    ...
                    <tbody>
                        ...
                        if($produtos != null){
                            foreach ($produtos as $p) {
                                ...
                                $estoque = $p->estoque;
                                foreach($prd as $pr){
									if($p->idProdutos == $pr->produtos_id)
									{
										$estoque = number_format($estoque - $pr->qtde);
									}
								}
                                echo '<td>'.$estoque.'</td>';
    ...
    <div class="span12" style="margin-left: 0">
        ...
        <div class="widget-box">
            <div class="widget-title">
              <span class="icon"> <i class="icon-signal"> </i> </span>
              <h5>Ordens de Serviço Em Aberto</h5></div>
            <div class="widget-content">
                <table class="table table-bordered">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        if($ordens != null){
                            ...
                            echo '<tr><td colspan="5" style="text-align: center;">Nenhuma Ordem de Serviço em aberto.</td></tr>';
                        }    
