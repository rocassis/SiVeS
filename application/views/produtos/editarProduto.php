        ...
        <div class="widget-box">
            ...
            <div class="widget-content nopadding">
                ...
                <form action="<?php echo current_url(); ?>" id="formProduto" method="post" class="form-horizontal" >
                    ...
                    <div class="control-group">
                        <label for="unidade" class="control-label">Adicionar Ao Estoque</label>
                        <div class="controls">
                            <input id="addEstoque" type="text" name="addEstoque" />
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="estoque" type="hidden" name="estoque" value="<?php echo $result->estoque; ?>"  />
                            <label > <?php echo $result->estoque; ?></label>
                        </div>
                    </div>

					<div class="control-group">
                        <label for="unidade" class="control-label">Estoque Minimo</label>
                        <div class="controls">
