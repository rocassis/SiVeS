                                        ...
                                        <table class="table table-bordered" id="tblProdutos">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($produtos as $p) {
                                                    ...
                                                    echo '<td><a href="'.base_url().'index.php/vendas/addMenosProduto/'.$p->idItens.'/'.$p->precoVenda.'/'.$p->subTotal.'/'.$p->quantidade.'/'.$p->vendas_id.'" class="btn btn-danger"><i class="icon-minus icon-white"></i></a>			'.$p->quantidade.'			<a href="'.base_url().'index.php/vendas/addMaisProduto/'.$p->idItens.'/'.$p->precoVenda.'/'.$p->subTotal.'/'.$p->quantidade.'/'.$p->vendas_id.'" class="btn btn-primary"><i class="icon-plus icon-white"></i></a></td>';
                                                    echo '<td><a href="'.base_url().'index.php/vendas/removeProduto/'.$p->idItens.'/'.$p->vendas_id.'/'.$p->quantidade.'/'.$p->idProdutos.'" title="Excluir Produto" class="btn btn-danger"><i class="icon-remove icon-white"></i></a></td>';
